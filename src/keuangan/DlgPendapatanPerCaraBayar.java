...
public final class DlgPendapatanPerCaraBayar extends javax.swing.JDialog {
    ...
    private double nilairalancash = 0, nilaimcucash = 0, nilairanapcash = 0, nilairalanpenjamin = 0, nilaimcupenjamin = 0, nilairanappenjamin = 0,
            ttlnilairalancash = 0, ttlnilaimcucash = 0, ttlnilairanapcash = 0, ttlnilairalanpenjamin = 0, ttlnilaimcupenjamin = 0, ttlnilairanappenjamin = 0, deposit = 0, ttldeposit = 0;
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        htmlContent.append(
                ...
                + "<td valign='middle' bgcolor='#FFFAF8' align='center' width='380px' colspan='3'>TOTAL</td>"
                + "</tr>"
                + "<tr class='isi'>"
                ...
                + "<td valign='middle' bgcolor='#FFFAF8' align='center' rowspan='2'>DEPOSIT</td>"
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    deposit = Sequel.cariIsiAngka("select sum(deposit.besar_deposit) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_inap on reg_periksa.no_rawat=nota_inap.no_rawat inner join deposit on deposit.no_rawat=nota_inap.no_rawat where reg_periksa.kd_pj='" + rs.getString("kd_pj") + "' and concat(nota_inap.tanggal,' ',nota_inap.jam) between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":" + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":" + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem() + "'");
                    ...
                    htmlContent.append(
                            ...
                            + "<td align='right'>" + Valid.SetAngka(deposit) + "</td>"
                            + "</tr>"
                    );
                    i++;
                }
            ...
            htmlContent.append(
                    ...
                    + "<td align='right'>" + Valid.SetAngka(ttldeposit) + "</td>"
                    + "</tr>"
            );
            LoadHTML.setText(
                    "<html>"
