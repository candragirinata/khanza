...
public final class SuratKewaspadaanKesehatan extends javax.swing.JDialog {
    ...
    */
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_kewaspadaan_kesehatan where tanggalperiksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"' ",
