...
public final class RMPenilaianAwalKeperawatanGigi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel79.setBounds(454, 910, 120, 23);
        ...
        scrollPane5.setBounds(454, 930, 400, 143);

        TglAsuhan.setForeground(new java.awt.Color(50, 70, 50));
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-03-2022 19:43:06" }));
        ...
        Scroll6.setBounds(10, 910, 400, 133);

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(16, 1050, 60, 23);
        ...
        BtnTambahMasalah.setBounds(363, 1050, 28, 23);
        ...
        TCariMasalah.setBounds(80, 1050, 215, 23);
        ...
        BtnCariMasalah.setBounds(299, 1050, 28, 23);
        ...
        BtnAllMasalah.setBounds(331, 1050, 28, 23);
                ...
                try {
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='11%'><b>VII. PENILAIAN TINGKAT NYERI</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='11%'><b>VIII. PENILAIAN INTRAORAL</b></td>"+
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            if(Valid.daysOld("./cache/masalahkeperawatangigi.iyem")<8){
                tampilMasalah2();
            }else{
                tampilMasalah();
            }
